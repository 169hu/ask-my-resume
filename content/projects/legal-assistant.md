...
tag: 主打
online_demo: true
demo_url: https://451a4f3f.r10.cpolar.top
metrics:
  - label: Faithfulness
    value: 98%
    hint: 回答可被法条支撑
...
- **合规拒答 2 道门卫**：非法律问题（is_law 守卫）→ 低置信度（审查守卫），宁可拒答也不编造。
...
- 量化评估：关键词命中 90.0%、**Faithfulness 98.0%**、**拒答率 100%**、**引文准确率 100%**。
...
- 模型可能漏判非法律问题：用 is_law + 置信度"双门卫"保证 100% 拒答率，宁可拒答不编造。